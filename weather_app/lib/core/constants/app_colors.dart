...
// class AppColor {
//   static Color lightPrimary = const Color.fromRGBO(0, 0, 0, 1.0);
//   static Color lightSecondary = const Color.fromRGBO(60, 60, 67, 0.6);
//   static Color lightTertiary = const Color.fromRGBO(60, 60, 67, 0.3);
//   static Color lightQuaternary = const Color.fromRGBO(60, 60, 67, 0.18);

//   static Color darkPrimary = const Color.fromRGBO(255, 255, 255, 1.0);
//   static Color darkSecondary = const Color.fromRGBO(235, 235, 245, 0.6);
//   static Color darkTertiary = const Color.fromRGBO(235, 235, 245, 0.3);
//   static Color darkQuaternary = const Color.fromRGBO(235, 235, 245, 0.18);

//   static LinearGradient linearColor1 = const LinearGradient(colors: [
//     Color.fromRGBO(46, 51, 90, 1.0),
//     Color.fromRGBO(28, 27, 51, 1.0)
//   ]);
//   static LinearGradient linearColor2 = const LinearGradient(colors: [
//     Color.fromRGBO(89, 54, 180, 1.0),
//     Color.fromRGBO(54, 42, 132, 1.0)
//   ]);
//   static LinearGradient linearColor3 = const LinearGradient(colors: [
//     Color.fromRGBO(66, 123, 209, 1.0),
//     Color.fromRGBO(193, 89, 236, 1.0)
//   ]);
//   static LinearGradient linearColor4 = const LinearGradient(colors: [
//     Color.fromRGBO(174, 201, 255, 1.0),
//     Color.fromRGBO(174, 201, 255, 1.0),
//     Color.fromRGBO(8, 48, 114, 1.0)
//   ]);
//   static RadialGradient radialColor = const RadialGradient(colors: [
//     Color.fromRGBO(247, 203, 253, 1.0),
//     Color.fromRGBO(119, 88, 209, 1.0)
//   ]);
//   static LinearGradient angularColor = const LinearGradient(colors: [
//     Color.fromRGBO(97, 47, 171, 0.0),
//     Color.fromRGBO(97, 47, 171, 1.0),
//     Color.fromRGBO(97, 47, 171, 0.0),
//     Color.fromRGBO(97, 47, 171, 1.0)
...
//   static Color solidColor1 = const Color.fromRGBO(72, 49, 157, 1.0);
//   static Color solidColor2 = const Color.fromRGBO(31, 29, 71, 1.0);
//   static Color solidColor3 = const Color.fromRGBO(196, 39, 251, 1.0);
//   static Color solidColor4 = const Color.fromRGBO(224, 217, 255, 1.0);
// }
